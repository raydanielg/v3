@php
    $startId = $startId ?? 'datepicker-range-start';
    $endId = $endId ?? 'datepicker-range-end';
    $startName = $startName ?? 'start';
    $endName = $endName ?? 'end';
    $startPlaceholder = $startPlaceholder ?? 'Select date start';
    $endPlaceholder = $endPlaceholder ?? 'Select date end';
@endphp
